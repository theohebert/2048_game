...
#Méthode mofiée pour ajouter un 2 ou un 4 aléatoirement dans une case vide de la matrice
#Le code récupéré n'ajoutait que des 2, ce qui rendait le jeu plus facile que l'original
def add_two(mat):
    empty_cells = []
